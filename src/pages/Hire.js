    ...
    <div className='hire'>
      <div className='resume'>
        ...
        <div className='section'>
          ...
          <div className='sectionContent'>
            I am able to pick up new tools and technologies quickly and easily. I am most experienced with programming in the node.js and react ecosystems using typescript, but am also comfortable using a wide variety of other languages and tools. I have been creating websites since I was 10 years old, and have professionally worked with a variety of database, api, and webserver frameworks. I also use Photoshop and Sketch to create UX mockups and original assets.
          </div>
        </div>
        <div className='section'>
          {renderSectionHeader('Employment History', BRIEFCASE_ICON)}
          <div className='sectionContent'>
            {renderEntry('Syntiant Corporation', 'https://www.syntiant.com', 'Remote', 'August 2022 - Present', 'Senior Software Engineer & UX Lead', 'Responsible for full-stack web application development for a wide variety of clients and use cases, as well as company-wide UX design. One of my main responsibilities is building and maintaining our computer vision training pipeline, using React.js for frontend with a C++ and PostgreSQL backend.')}
